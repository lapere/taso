...
def _arc(self, startp=None, midp=None, endp=None,
         center=None, direction=None, radius=None,
         angle=None, length=None, clockw=True):
	...
	astart = AngleBetweenTwoPoint(center[0], center[1], startp[0], startp[1])
 	...
 	if angle == None:
        ...
        box_x1 = center[0]-radius
        box_y1 = center[1]-radius
        box_x2 = center[0]+radius
        box_y2 = center[1]+radius

        arc = self.create_arc(box_x1, box_y1, box_x2, box_y2, 
                                    extent=-angle,start=astart, 
...
if __name__ == '__main__':
    ...
    #_arc(c, startp=(100, 100), angle=pi/2, endp=(100, 200))
    kw = dict(startp=(100, 100), endp=(300, 100), center=(200,100), midp=None)
    _arc(c, **kw)
