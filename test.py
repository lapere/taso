...
class Test:
    ...
    def __init__(self):
        ...
        menu_frame.addCommand("Tiedosto","Uusi", txt.canvas._new)
        menu_frame.addCommand("Tiedosto","Avaa", txt.canvas._open)
        menu_frame.addCommand("Tiedosto","Avaa DB", txt.canvas.open_db)
        ...
        menu_frame.addCommand("Muokkaa","Piilota", txt.canvas.hide)
        menu_frame.addCommand("Muokkaa","Älä piilota", txt.canvas.unhide)

        menu_frame.addCommand("Piirrä","Piste", txt.canvas.point)
        menu_frame.addCommand("Piirrä","Viiva", txt.canvas.line)
        menu_frame.addCommand("Piirrä","Teksti", txt.canvas.text)

        menu_frame.addCommand("Elementti","X", txt.canvas.xElement)
        menu_frame.addCommand("Elementti","Y", txt.canvas.yElement)
        menu_frame.addCommand("Elementti","Z", txt.canvas.zElement)
