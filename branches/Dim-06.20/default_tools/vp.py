...
class VisualPrimitive:
    ...
    def entry_set(self):
        self.canvas.cmd.set(self.value)
...
class A(VisualPrimitive):
    ...
    def __init__(self, canvas, point, a, origo):
        VisualPrimitive.__init__(self, canvas, a)
        self.origo = origo    
        self.point = point
        self.point.fellows.update({self.id:self})
...
class Point(VisualPrimitive):
    ...
    def __init__(self, canvas, x, y):
        VisualPrimitive.__init__(self, canvas, None)
        self.x = x
        self.y = y
        ...
        self.list_param = [x.value - 1, y.value - 1, x.value + 1, y.value + 1]
        self.kw_param = dict(fill="black", width=6)
