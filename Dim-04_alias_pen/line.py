...
class Line(Item):
    ...
    def __init__(self, canvas, startp, endp, style = dict()):
        ...
        self.style = dict(width=self.canvas.line_style)
    ...
    def repaint(self):
        self.canvas.coords(self.tag, self.startp.x(), self.startp.y(), self.endp.x(), self.endp.y())  
